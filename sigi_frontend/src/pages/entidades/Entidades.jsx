    ...
    return (
        <Layout>
            <div className="pagina-header">
                <div>
                    <h1 className="pagina-titulo">Seguridad Social</h1>
                    <p className="pagina-subtitulo">Gestion de entidades de afiliacion: EPS, ARL, Caja de Compensacion y Fondo de Pension</p>
                </div>
            ...
            <div className="filtros">
                <select value={filtroTipo} onChange={(e) => setFiltroTipo(e.target.value)}>
                    ...
                    <option value="CCF">Caja de Compensación</option>
                    <option value="AFP">Fondo de Pensión</option>
                </select>
            </div>
