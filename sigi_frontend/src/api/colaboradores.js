...
export const retirarColaborador    = (id, data) => api.post(`/colaboradores/${id}/retirar/`, data);
export const reactivarColaborador  = (id) => api.post(`/colaboradores/${id}/reactivar/`);
